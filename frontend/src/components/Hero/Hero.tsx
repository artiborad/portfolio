  ...
  return (
    <section id="hero" className="reveal mx-auto grid max-w-7xl gap-10 px-6 pb-16 pt-20 md:grid-cols-2 md:items-center md:pt-24">
      <div className="hero-enter-left">
        <p className="mb-4 text-sm uppercase tracking-[0.2em] text-pink-300">Senior Node.js Backend Developer</p>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex h-11 w-11 items-center justify-center rounded-full border border-slate-700 text-slate-200 transition hover:border-pink-300 hover:text-pink-300"
          >
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <a
            className="rounded-lg bg-gradient-to-r from-pink-500 to-violet-500 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-pink-500/25 transition hover:opacity-90"
            href="#contact"
          >
            Contact Me
          </a>
      ...
      <div className="hero-enter-right relative flex min-h-[320px] items-center justify-center rounded-2xl border border-slate-800 bg-slate-900/40">
        <div className="absolute h-56 w-56 rounded-full bg-pink-500/20 blur-2xl" />
